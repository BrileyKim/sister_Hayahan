        ...
        <div class="hero-post-slides owl-carousel">
            ...
            <div class="single-slide">
                ...
                <div class="blog-thumbnail">
                    <a href="#"><img src="${path }/resources/bueno-master/img/bg-img/1.jpg" alt=""></a>
                </div>
            ...
            <div class="single-slide">
                <!-- Blog Thumbnail -->
                <div class="blog-thumbnail">
                    <a href="#"><img src="${path }/resources/bueno-master/img/bg-img/2.jpg" alt=""></a>
                </div>
            ...
            <div class="single-slide">
                <!-- Blog Thumbnail -->
                <div class="blog-thumbnail">
                    <a href="#"><img src="${path }/resources/bueno-master/img/bg-img/3.jpg" alt=""></a>
                </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post-catagory mb-30">
                        <img src="${path }/resources/bueno-master/img/bg-img/4.jpg" alt="">
                        <!-- Content -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post-catagory mb-30">
                        <img src="${path }/resources/bueno-master/img/bg-img/5.jpg" alt="">
                        <!-- Content -->
                        <div class="catagory-content-bg">
                            <div class="catagory-content">
                                <a href="#" class="post-tag">The Best</a>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post-catagory mb-30">
                        <img src="${path }/resources/bueno-master/img/bg-img/6.jpg" alt="">
                        <!-- Content -->
                        <div class="catagory-content-bg">
                            <div class="catagory-content">
                                <a href="#" class="post-tag">The Best</a>
    ...
    <div class="big-posts-area mb-50">
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-12 col-md-6">
                    <div class="big-post-thumbnail mb-50">
                        <img src="${path }/resources/bueno-master/img/bg-img/7.jpg" alt="">
                    </div>
                </div>
                <div class="col-12 col-md-6">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6">
                    <div class="big-post-thumbnail mb-50">
                        <img src="${path }/resources/bueno-master/img/bg-img/8.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-sm-9 col-md-6 col-lg-4 col-xl-3">
                    <div class="sidebar-area">
                        ...
                        <div class="single-widget-area add-widget mb-30">
                            <img src="${path }/resources/bueno-master/img/bg-img/add.png" alt="">
                        </div>
                        ...
                        <div class="single-widget-area post-widget">
                            ...
                            <div class="single-post-area d-flex">
                                <!-- Blog Thumbnail -->
                                <div class="blog-thumbnail">
                                    <img src="${path }/resources/bueno-master/img/bg-img/12.jpg" alt="">
                                </div>
                                <!-- Blog Content -->
                                <div class="blog-content">
                                    <a href="#" class="post-title">Friend eggs with ham</a>
                            ...
                            <div class="single-post-area d-flex mb-30">
                                <!-- Blog Thumbnail -->
                                <div class="blog-thumbnail">
                                    <img src="${path }/resources/bueno-master/img/bg-img/13.jpg" alt="">
                                </div>
                                <!-- Blog Content -->
                                <div class="blog-content">
                            ...
                            <div class="single-post-area d-flex">
                                <!-- Blog Thumbnail -->
                                <div class="blog-thumbnail">
                                    <img src="${path }/resources/bueno-master/img/bg-img/14.jpg" alt="">
                                </div>
                                <!-- Blog Content -->
                                <div class="blog-content">
                            ...
                            <div class="single-post-area d-flex">
                                <!-- Blog Thumbnail -->
                                <div class="blog-thumbnail">
                                    <img src="${path }/resources/bueno-master/img/bg-img/15.jpg" alt="">
                                </div>
                                <!-- Blog Content -->
                                <div class="blog-content">
                            ...
                            <div class="single-post-area d-flex">
                                <!-- Blog Thumbnail -->
                                <div class="blog-thumbnail">
                                    <img src="${path }/resources/bueno-master/img/bg-img/16.jpg" alt="">
                                </div>
                                <!-- Blog Content -->
                                <div class="blog-content">
                                    <a href="#" class="post-title">Burger with fries</a>
